    ...
    render(){
        ...
        return(
            <div id="quote-box">
                ...
                <div>
                <a href={`https://twitter.com/intent/tweet?text="${quote}"-${author}`} target="_blank" id="tweet-quote" style={{backgroundColor:colorDisplay}}><i className="fab fa-twitter"></i></a>
                <button id="new-quote" onClick={this.props.newQuote} style={{backgroundColor:colorDisplay}}>New Quote</button>
                </div>
